...
import com.example.tarea_api.models.AutoNuevo;
...
public class AutoNuevoActivity extends AppCompatActivity {
    ...
    private void fetchVehiculosFromApi(RecyclerView recyclerView) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                ...
                response -> {
                    ...
                    setupRecyclerView(recyclerView, autos);
                },
                error -> Toast.makeText(this, "Error al cargar autos nuevos", Toast.LENGTH_SHORT).show()
        );
